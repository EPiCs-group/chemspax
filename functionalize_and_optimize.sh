...
# loop over skeleton list and set index back to 1
    ...
    xtb --input xtb.inp ${TARGET_NAME}_${i}.xyz --cma --cycles 200 --gfn 2 --opt --chrg 0 --uhf 0 --gbsa acetonitrile > xtb.out
    ...
    cd -
        ...
        # optimization
	    cd substituents_xyz/automatically_generated
        xtb --input xtb.inp ${TARGET_NAME}_$((i+1)).xyz --cma --cycles 200 --gfn 2 --opt --chrg 0 --uhf 0 --gbsa acetonitrile > xtb.out
        # write functionalization list to optimized file to be able to use that file as source for new functionalizations
