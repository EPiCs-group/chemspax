...
class Complex:
    ...
    def generate_substituent_and_write_xyz(self, filename, substituent_1_atom, substituent_2_atom, substituent_3_atom,
        ...
        substituent_1 = pd.DataFrame([[substituent_1_atom.upper(), v_1[0], v_1[1], v_1[2]]],
                                     columns=['atom', 'x', 'y', 'z']).set_index('atom')
        substituent_2 = pd.DataFrame([[substituent_2_atom.upper(), v_2[0], v_2[1], v_2[2]]],
                                     columns=['atom', 'x', 'y', 'z']).set_index('atom')
        substituent_3 = pd.DataFrame([[substituent_3_atom.upper(), v_3[0], v_3[1], v_3[2]]],
                                     columns=['atom', 'x', 'y', 'z']).set_index('atom')
