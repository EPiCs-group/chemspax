...
# ChemSpaX setup
import glob
from chemspax.subfunctionalisations import *
...
def final_functionalisation(skeleton):
    ...
    path_to_skeletons = os.path.join(working_directory, "skeletons_subfunctionalisation")
    skeleton_list = glob.glob(os.path.join(working_directory, "skeletons_subfunctionalisation", str(list(func_sites.keys())[skeleton])+'.xyz'))
    ...
    shutil.copy(os.path.join(os.getcwd(),'tmp',str(list(func_sites.keys())[skeleton])+'_func_'+str(func_sites[list(func_sites.keys())[skeleton]])+'.mol'),os.path.join(os.getcwd(),'results_subfunctionalisation','struc_'+str(struccounter)+'.mol'))
    shutil.copy(os.path.join(os.getcwd(),'tmp',str(list(func_sites.keys())[skeleton])+'_func_'+str(func_sites[list(func_sites.keys())[skeleton]])+'.xyz'),os.path.join(os.getcwd(),'results_subfunctionalisation','struc_'+str(struccounter)+'.xyz'))
...
if __name__ == "__main__":
    ...
    initialise(["tmp","functionalisations","results_subfunctionalisation"])
    print("Folders cleared")
    func_sites=check_skeleton_sites('skeletons_subfunctionalisation')
