...
def main(skeleton_list, substituent_list, path_to_database=path_to_database, path_to_substituents = path_to_substituents, path_to_output = path_to_output):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-k', '--skeleton', help='Provide path for skeletons in .xyz format', required=False,action='store', default=glob.glob(CHEMSPAX_HOME_DIR+"/skeletons/*.xyz"))
...
#    list_of_skeleton_files = glob.glob("skeletons/*.xyz")
    ...
    main(list_of_skeleton_files, substituent_list, path_to_database=path_to_database, path_to_substituents = path_to_substituents, path_to_output = args.output)
